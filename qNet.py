...
class qNet(nn.Module):
    def __init__(self):
        ...
        self.linear1 = torch.nn.Linear(6400, 120)
        self.linear2 = torch.nn.Linear(120, 6)
        self.batchNorm1D120 = torch.nn.BatchNorm1d(120)
    ...
    def forward(self, nn_input):
        ...
        output2 = self.maxPool(self.relu(self.batchNorm128(self.layer2(output1)))) # 136x66x128
